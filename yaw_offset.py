...
class MPU6050Controller:
    def __init__(self, scl_pin, sda_pin, uart_id, baud_rate, rx_pin, tx_pin, dt):
    ...
    def start_test(self):
        self.cnt = 0
        self.timer = Timer(1)
        self.timer.init(period=int(self.dt*1000), mode=Timer.PERIODIC, callback=self.main)
...
if __name__ == "__main__":
    controller = MPU6050Controller(42, 41, 1, 115200, 12, 11, 0.002)
