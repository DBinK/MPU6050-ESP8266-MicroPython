...
class IMUController:
    def __init__(self):
        ...
        self.yaw_last   = 0
        self.yaw_offset = 0
        self.fix_yaw_offset = 0.0001927922
    ...
    def read_data_and_update(self,tim_1):
        ...
        self.pitch_deg = self.window_filter(self.pitch_deg, self.pitch_deg_values, 20)
        self.roll_deg  = self.window_filter(self.roll_deg,  self.roll_deg_values,  20)
        self.yaw_deg   = self.window_filter(self.yaw_deg,   self.yaw_fix_values,   50)
